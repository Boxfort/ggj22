...
var words = ["secret", "forever", "chocolate", "cats", "iloveyou", "welcome", "superman", "master", "sunshine", "football", "monkey", "qwerty", "open", "horse", "battery", "staple", "password", "shoes", "crab", "query", "Gigabyte", "mystery", "buffer"]
